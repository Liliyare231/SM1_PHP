...
<body>
    ...
    $student = [
        ...
        'socium' => 'instagram, nickname "Liliyare231"'
    ]
    ?>
    <div class="block">
        <?
        echo 'Я, '.$student['surname']. ' '. $student['name'].', студентка  4 курса группы '. $student['group'].' . В свободное время я занимоюсь - '.$student['hobbi'].'.<br>'.$student['socium'];
        ?>
    </div>
